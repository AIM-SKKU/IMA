...
from ..net_utils import Fusionmodel
...
class DualSwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            ...
            fuse = Fusionmodel(in_channels=int(embed_dim * 2 ** i_layer), patch_h=patch_h[i_layer], patch_w=patch_w[i_layer])
            self.FusionBlocks.append(fuse)
    ...
    def forward(self, x, x_d):
        ...
        for i in range(self.num_layers):
            ...
            if i in self.out_indices:
                ...
                x_out, x_out_d, out = self.FusionBlocks(x_out, x_out_d)

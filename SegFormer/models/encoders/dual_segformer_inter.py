...
from ..net_utils_youjia import Fusionmodel
import math
import time
...
class RGBXTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        ''' inter - youjia '''
        # self.FusionBlock_0 = Fusionmodel(in_channels=embed_dims[0], patch_h=28, patch_w=28)
        self.FusionBlock_1 = Fusionmodel(in_channels=embed_dims[1], patch_h=28, patch_w=28)
        self.FusionBlock_2 = Fusionmodel(in_channels=embed_dims[2], patch_h=28, patch_w=28)
        self.FusionBlock_3 = Fusionmodel(in_channels=embed_dims[3], patch_h=28, patch_w=28)
    ...
    def forward_features(self, x_rgb, x_e):
        ...
        # stage 1
        x_rgb, H, W = self.patch_embed1(x_rgb)  # [8,19200,64], 120,160
        # B H*W/16 C

...
from ..net_utils_intra import Fusionmodel
import math
import time
...
class RGBXTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        ''' intra '''
        # self.FusionBlock_0 = Fusionmodel(in_channels=embed_dims[0], patch_h=12, patch_w=12)
        self.FusionBlock_1 = Fusionmodel(in_channels=embed_dims[1], patch_h=12, patch_w=12)
        self.FusionBlock_2 = Fusionmodel(in_channels=embed_dims[2], patch_h=12, patch_w=12)
        self.FusionBlock_3 = Fusionmodel(in_channels=embed_dims[3], patch_h=12, patch_w=12)
